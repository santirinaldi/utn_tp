...
exports.UtilsComponent = void 0;
const components_1 = require("typedoc/dist/lib/output/components");
const theme_1 = require("../theme");
let UtilsComponent = class UtilsComponent extends components_1.ContextAwareRendererComponent {
    initialize() {
        super.initialize();
...
UtilsComponent = __decorate([
    components_1.Component({ name: 'github-wiki-utils' })
], UtilsComponent);
