...
class Property {
  ...
  fromJSON(json) {
    ...
    if (this.type == PropertyType.COLOR)
      valueClass = Color;
    else if (this.type == PropertyType.TEXT_DATA)
      valueClass = TextDocument;
    this.values = this.isAnimated || this.type == PropertyType.TEXT_DATA ? json.k.map((v) => new KeyFrame().fromJSON(v, valueClass)) : [new KeyFrame().fromJSON({t: 0, s: json.k}, valueClass)];
    if (this.type === PropertyType.COLOR) {
...
class Gradient {
  constructor() {
    this.gradientColors = new GradientColorsProperty(this, PropertyType.GRADIENT);
  }
  get colorCount() {
...
class OffsetPathShape extends Shape {
  constructor() {
    super(...arguments);
    this.type = ShapeType.OFFSET_PATH;
    this.amount = new Property(this, PropertyType.AMOUNT);
    this.lineJoin = LineJoinType.MITER;
    this.miterLimit = new Property(this, PropertyType.MITER_LIMIT);
  }
  fromJSON(json) {
    super.fromJSON(json);
...
class PuckerBloatShape extends Shape {
  constructor() {
    super(...arguments);
    this.type = ShapeType.PUCKER_BLOAT;
    this.amount = new Property(this, PropertyType.AMOUNT);
  }
  fromJSON(json) {
    super.fromJSON(json);
...
class TwistShape extends Shape {
  constructor() {
    super(...arguments);
    this.type = ShapeType.TWIST;
    this.angle = new Property(this, PropertyType.ANGLE);
    this.center = new Property(this, PropertyType.CENTER);
  }
  fromJSON(json) {
    super.fromJSON(json);
...
class ZigZagShape extends Shape {
  constructor() {
    super(...arguments);
    this.type = ShapeType.ZIG_ZAG;
    this.radius = new Property(this, PropertyType.RADIUS);
    this.distance = new Property(this, PropertyType.DISTANCE);
    this.numberOfRidges = new Property(this, PropertyType.POINTS);
  }
  fromJSON(json) {
    super.fromJSON(json);
...
class TextSelector {
  constructor() {
    ...
    this.textShape = TextShape.SQUARE;
    this.basedOn = TextBased.CHARACTERS;
    this.maxEase = new Property(this, PropertyType.MAX_EASE);
    this.minEase = new Property(this, PropertyType.MIN_EASE);
    this.maxAmount = new Property(this, PropertyType.MAX_AMOUNT);
  }
  fromJSON(json) {
...
class TextOptions {
  constructor() {
    this.alignment = new Property(this, PropertyType.TEXT_ALIGNMENT);
    this.grouping = TextGrouping.CHARACTERS;
  }
  fromJSON(json) {
...
class TextData {
  constructor() {
    this.textDocument = new Property(this, PropertyType.TEXT_DATA);
